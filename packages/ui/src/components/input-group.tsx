...
function InputGroupAddon({
  ...
  // Mouse-only convenience: clicking the padding around the input/textarea
  // focuses it, mirroring a <label> click. Keyboard users already reach the
  // control directly via Tab, so this is attached imperatively rather than
  // via onClick to avoid presenting the addon itself as a focusable control.
  useEffect(() => {
